...
export const NATIONAL_PAGES: NationalPageEntry[] = [
  ...
  {
    key: 'steelcase-leap-v2-occasion',
    title: 'Modèle — Steelcase Leap V2',
    displayName: 'Leap V2 occasion',
    route: '/steelcase-leap-v2-occasion',
    section: 'produit-vertical',
    icon: '🪑',
  },
  {
  ...
  {
    key: 'marques-herman-miller',
    title: 'Marques — Herman Miller',
    displayName: 'Herman Miller',
    route: '/marques/herman-miller',
    section: 'marques',
    icon: '🏷️',
  },
  {
  ...
  {
    key: 'marques-haworth',
    title: 'Marques — Haworth',
    displayName: 'Haworth',
    route: '/marques/haworth',
    section: 'marques',
    icon: '🏷️',
  },
]
