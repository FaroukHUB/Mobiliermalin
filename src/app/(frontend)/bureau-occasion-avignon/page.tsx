...
export const metadata: Metadata = {
  ...
  title: 'Bureaux d\'occasion livrés à Avignon — Vaucluse',
  description:
  ...
  keywords: [
    ...
    'mobilier bureau Avignon',
    'mobilier de bureau Avignon',
    'bureau professionnel Avignon',
    'livraison bureau Avignon',
    'mobilier bureau Vaucluse',
    'meuble bureau Avignon',
    'bureau reconditionné Avignon',
    'magasin meuble Avignon',
  ],
  alternates: { canonical: `${siteUrl}/bureau-occasion-avignon` },
  openGraph: {
...
export default async function AvignonPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Accueil', item: siteUrl },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Mobilier de bureau à Avignon',
        item: `${siteUrl}/bureau-occasion-avignon`,
      },
    ],
  }
  ...
  const localBusinessSchema = {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    '@id': `${siteUrl}/#localbusiness-avignon`,
    name: 'Mobilier Malin — Bureaux d\'occasion livrés à Avignon',
    description:
      'Livraison de mobilier de bureau reconditionné Steelcase, Herman Miller, Haworth, Vitra à Avignon et dans tout le Vaucluse depuis notre atelier de La Penne-sur-Huveaune.',
    url: `${siteUrl}/bureau-occasion-avignon`,
...
{/* ═══ HERO ═══ */}
        ...
        <div className="container relative py-16 md:py-24 w-full">
          <nav aria-label="Fil d'Ariane" className="text-xs text-ivory/60">
            <ol className="flex items-center gap-2 flex-wrap">
              ...
              <li className="text-gold">Bureaux d&apos;occasion à Avignon</li>
            </ol>
          </nav>

          <div className="mt-10 max-w-3xl">
            <p className="eyebrow text-gold">Livraison Vaucluse</p>
            <h1 className="text-display-xl mt-4 font-serif leading-[1.05] text-ivory">
              Vos bureaux d&apos;occasion livrés à Avignon
            </h1>
            <div className="h-px w-16 bg-gold mt-8" />
            <p className="mt-8 text-lg text-ivory/85 leading-relaxed">
              Avignon est à <strong className="text-ivory">1 h 15
              par l&apos;A7</strong> de notre atelier de La
              Penne-sur-Huveaune. Nous livrons régulièrement dans toute la
        ...
        <div className="mt-10 space-y-6 text-lg text-ink-soft leading-relaxed">
          <Reveal>
            <p>
              ...
              sortie est de Marseille. L&apos;A7 nous mène jusqu&apos;à
              Avignon en une heure et quinze minutes environ, par une route
              que nous empruntons fréquemment pour livrer des entreprises,
              cabinets et collectivités du Vaucluse. Le Vaucluse fait
              partie de notre couverture régulière, pas d&apos;une exception
              tarifée à part.
            </p>
          </Reveal>
          ...
          <Reveal delay={80}>
            <p>
              Nous mutualisons les déplacements avignonnais et vauclusiens
              avec d&apos;autres livraisons sur la même tournée — ce qui
              nous permet de proposer un tarif de transport très accessible
              comparé à ce que coûterait un aller-retour dédié à un seul
              poste. C&apos;est cette mutualisation qui rend notre offre
              pertinente à plus de cent kilomètres de l&apos;atelier.
            </p>
          </Reveal>

          <Reveal delay={160}>
            <p>
              Que vous équipiez un cabinet d&apos;avocats au centre
              d&apos;Avignon, un coworking sur Villeneuve, un atelier
              artisanal sur Sorgues ou un bureau dans un mas en pierre
              du côté de Châteaurenard — nous nous adaptons. Pour chaque
              demande, nous étudions le tarif livraison le plus juste,
              en mutualisant si possible avec d&apos;autres clients
              vauclusiens de la même semaine.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container py-16 md:py-24">
          <Reveal>
            <div className="max-w-2xl mb-12">
              ...
              <h2 className="text-display mt-3 font-serif">
                Comment se déroule une commande depuis Avignon
              </h2>
              <div className="gold-divider mx-0 mt-6" />
            </div>
          </Reveal>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Reveal>
              <article className="bg-ivory border border-line p-7 h-full">
                ...
                <p className="mt-3 text-sm text-ink-soft leading-relaxed">
                  ...
                  produit. Indiquez-nous votre adresse à Avignon (intra-muros,
                  ZTL ou hors centre) et les contraintes d&apos;accès :
                  étage, ascenseur, place de stationnement.
                </p>
              </article>
            </Reveal>
            ...
            <Reveal delay={80}>
              <article className="bg-ivory border border-line p-7 h-full">
                ...
                <p className="mt-3 text-sm text-ink-soft leading-relaxed">
                  Vous recevez sous 24 h ouvrées un devis avec la date de
                  la prochaine tournée Vaucluse — généralement sous une à
                  deux semaines. Si elle ne vous convient pas, nous vous
      ...
      <section className="bg-ink text-ivory">
        <div className="container py-16 md:py-20 max-w-3xl mx-auto text-center">
          ...
          <p className="eyebrow text-gold mt-4">Vous êtes sur Avignon ou dans le Vaucluse ?</p>
